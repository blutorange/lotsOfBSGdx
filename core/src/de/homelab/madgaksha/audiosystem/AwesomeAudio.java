...
/**
 * Contains logic for registering decoders for other audio file formats
 * than those supported by libGdx. The {@link #newMusic(FileHandle)} checks
 * for the file type and calls the appropriate decoder.
 * 
...
public class AwesomeAudio implements Audio {
	...
	public static void initialize() {
		if (oldAudio != null) return; // we only need to initialize once
		oldAudio = Gdx.audio;
