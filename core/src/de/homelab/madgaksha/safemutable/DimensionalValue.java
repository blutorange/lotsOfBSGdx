...
public abstract class DimensionalValue implements Clone<DimensionalValue>, SafeMutable<DimensionalValue> {
	public abstract int getDimension();
	public abstract float[] getValues();
	public abstract void setValues(final float[] values);
	public abstract DimensionalValue newObject();
	@Override
	public DimensionalValue cloneObject() {
		final DimensionalValue val = newObject();
		val.setValues(getValues());
		return val;
	}
	@Override
	public DimensionalValue cloneValue() {
		return cloneObject();
	}
	@Override
	public void setValue(final DimensionalValue value) {
		setValues(value.getValues());
	}


	public static class Value1D extends DimensionalValue {
	...
	public static class Value2D extends DimensionalValue {
	...
	public static class Value3D extends DimensionalValue {
	...
	public static class Value4D extends DimensionalValue {
