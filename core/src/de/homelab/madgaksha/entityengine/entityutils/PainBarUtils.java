...
public class PainBarUtils {
	...
	/**
	 * @param e Entity to check for pain points
	...
	/**
	 * @param e Entity to check for pain points ratio.
	 * @return Current pain points ratio, or -1.0f if it does not possess pain points.
	 */
