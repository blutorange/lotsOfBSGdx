...
/**
 * Make an entity shake as if there were an earthquake. Applying this to the
 * camera entity results in a nifty screen quake.
 * 
 * Modifies the {@link PositionComponent#offsetX} etc. of an entity's
