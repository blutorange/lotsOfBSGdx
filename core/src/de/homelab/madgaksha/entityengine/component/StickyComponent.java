...
/**
 * A component for entities always positioned at a certain offset to another entity. 
 * @author madgaksha
 *
 */
public class StickyComponent implements Component, Poolable {
	...
	/** Whether the offset specified should be relative to the camera looking direction. */
	...
	public void setup(PositionComponent pc, float offsetX, float offsetY, boolean ignoreOffset, boolean offsetRelativeToCamera) {
