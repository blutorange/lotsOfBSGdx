 ...
 * @author mad_gaksha
 */
public class ReceiveTouchGroup05Component extends ReceiveTouchComponent {
	public ReceiveTouchGroup05Component() {
	}

	public ReceiveTouchGroup05Component(IReceive t) {
		super(t);
	}
}
