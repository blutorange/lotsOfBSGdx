...
public class ParticleEffectMaker extends EntityMaker {
	...
	/**
	 * Adds the appropriate components to an {@link Entity} to be used as a ParticleEffect component.
	 * Drawn in game coordinates.
	 * @param entity Entity to setup.
	 * @param shape Shape of the entity. Particle effect will be positioned at the center of its bounding box.
	 * @param particleEffect Particle effect to add.
	 * @param spin Angular velocity. 0.0f to disable spinning.
	 */
	...
	/**
	 * Adds the appropriate components to an {@link Entity} to be used as a ParticleEffect component.
	 * Drawn in screen coordinates, useful for rotation. Position is unaffected.
	 * @param entity Entity to setup.
	 * @param shape Shape of the entity. Particle effect will be positioned at the center of its bounding box.
	 * @param particleEffect Particle effect to add.
	 * @param spin Angular velocity. 0.0f to disable spinning.
	...
	private void setup(ParticleEffectComponent particleEffectComponent, Entity entity, Shape2D shape, EParticleEffect particleEffect, float spin) {
		super.setup(entity);
