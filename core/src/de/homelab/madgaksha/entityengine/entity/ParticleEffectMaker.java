...
public class ParticleEffectMaker extends EntityMaker {
	 ...
	 */
	public void setup(Entity entity, Shape2D shape, EParticleEffect particleEffect, float spin) {
		super.setup(entity);
		
		final PositionComponent positionComponent = MakerUtils.makePositionAtCenter(shape);
		final ParticleEffectComponent particleEffectComponent = new ParticleEffectComponent(particleEffect);
