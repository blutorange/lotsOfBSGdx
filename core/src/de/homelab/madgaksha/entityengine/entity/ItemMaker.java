...
public class ItemMaker extends EntityMaker {
	 ...
	 */
	public boolean setup(Entity entity, Shape2D shape, MapProperties props, IMapItem mapItem, Float angularVelocity,
			Vector3 axis) {
		...
		// Apply defaults.
		if (axis == null)
			axis = mapItem.getDefaultAxisOfRotation();
		if (angularVelocity == null)
			angularVelocity = mapItem.getDefaultAngularVelocity();
