...
public abstract class ALayer {
	...
	/**
	 * @return Whether this layer is currently blocking drawing operations from
	 *         propagating down the stack.
	 */
	public abstract boolean isBlockDraw();

	/**
	 * @return Whether this layer is currently blocking update operations from
	 *         propagating down the stack.
	 */
