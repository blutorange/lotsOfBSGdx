...
/**
 * Component every entity needs to have for it to be processed by an entity
 * system requiring access to deltaTime. <br>
 * The deltaTime passed in by ashley to the update function must not be used.
 * <br>
 * deltaTime must be accessed via
 * <code>Mapper.temporalComponent.get(entity).deltaTime</code>.
 * 
 * @author madgaksha
 *
 */
