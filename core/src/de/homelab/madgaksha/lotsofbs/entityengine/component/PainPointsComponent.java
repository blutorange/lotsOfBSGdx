...
public class PainPointsComponent implements Component, Poolable {
	...
	private static final float DEFAULT_PAIN_POINTS_RATIO = ((float) DEFAULT_PAIN_POINTS)
			/ ((float) DEFAULT_MAX_PAIN_POINTS);
	...
	public void updatePainPoints() {
		...
		if (painPoints < 0)
			painPoints = 0;
		if (painPoints > maxPainPoints)
			painPoints = maxPainPoints;
