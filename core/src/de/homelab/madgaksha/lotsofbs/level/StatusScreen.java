...
import de.homelab.madgaksha.lotsofbs.util.Layouter;
import de.homelab.madgaksha.lotsofbs.util.MiscUtils;
...
public class StatusScreen {
	...
	public void addTokugiSign(ATokugi aTokugi) {
		ETexture signTexture = aTokugi.getSign();
		if (signTexture != null) {
			TokugiSign tokugiSign = addNewTokugiSign();
