 ...
 * 
 * This intentionally violates the contract of
 * the {@link InputStream} interface that {@link InputStream#read()}
 * must return the next byte. It only returns the next bit.
 * 
 * @author mad_gaksha
 *
 */
