...
public interface IMapItem {
	 ...
	 * @param e Entity to be setup.
	 * @param props Map properties for this item object.
	 */
	...
	/** Once the player enters the active area of the item, the item starts
	 * to move towards the player, getting smaller the closer it gets. When it 
	 * touches the player, the player receives the item. The active area of
	 * the item is the bounding box of the item's model, enlarged by this factor.
	 * @return The factor by which the item's model bounding box is multiplied to obtain the active area. 
	 */
